...
const publications = [
  { title: "Publicação DJE – Proc. 0012345", date: "23 Fev 2026", type: "Intimação", read: false, summary: "Intimação para apresentar contestação no prazo de 15 dias." },
  { title: "Publicação DJE – Proc. 0098765", date: "22 Fev 2026", type: "Sentença", read: false, summary: "Sentença proferida — procedência parcial dos pedidos." },
  { title: "Publicação DJE – Proc. 1234567", date: "20 Fev 2026", type: "Despacho", read: true, summary: "Despacho determinando perícia técnica." },
  { title: "Publicação DJE – Proc. 0054321", date: "18 Fev 2026", type: "Movimentação", read: true, summary: "Juntada de petição do réu aos autos." },
];
